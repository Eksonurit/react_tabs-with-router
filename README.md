...
- Open one more terminal and run tests with `npm test` to ensur your solution is correct.
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://Eksonurit.github.io/react_tabs-with-router/) and add it to the PR description.
